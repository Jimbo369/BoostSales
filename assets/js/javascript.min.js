...
if(p.promise(_).complete=g.add,_.success=_.done,_.error=_.fail,d.url=((e||d.url||ft)+"").replace(ht,"").replace(yt,dt[1]+"//"),d.type=t.method||t.type||d.method||d.type,d.dataTypes=Z.trim(d.dataType||"*").toLowerCase().match(he)||[""],null==d.crossDomain&&(l=xt.exec(d.url.toLowerCase()),d.crossDomain=!(!l||l[1]===dt[1]&&l[2]===dt[2]&&(l[3]||("https:"===l[1]?"80":"443"))===(dt[3]||("https:"===dt[1]?"80":"443")))),d.data&&d.processData&&"string"!=typeof d.data&&(d.data=Z.param(d.data,d.traditional)),M(bt,d,t,_),2===x)return _
